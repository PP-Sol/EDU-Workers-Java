...
public class WorkerBasic extends Worker implements Runnable
{
    Thread v;
    ...
    public WorkerBasic(int pocX, int pocY, int col) 
    {
        super(pocX,pocY,col);
        v = new Thread(this,"WorkerBasic");
        v.setPriority(6);
    ...
    public void run()   //chovani vlakna - chovani delnika
    {
      ...
      while(true)
      {
        ...
        if(index!=-1)    //je nejaky cerny naklad
        {
            ...
            index = this.nearestCargo(this.color);    //najdeme nejblizsi skupinu nakladu nasi barvy
