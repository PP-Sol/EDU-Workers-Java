...
public class WorkerHigh extends Worker implements Runnable
{
    Thread v;
    ...
    public WorkerHigh(int pocX, int pocY, int col) 
    {
        super(pocX,pocY,col);
        v = new Thread(this,"WorkerBasic");
        v.setPriority(6);
    ...
    public void run()   //chovani vlakna - chovani delnika
    {
      ...
      while(true)
      {
        index = this.farestCargo(globalVar.CERNA);    //najdeme nejblizsi naklad cerny (nepouzity naklad)
